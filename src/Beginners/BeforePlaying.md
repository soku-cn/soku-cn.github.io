...
![](https://bu.dusays.com/2024/07/10/668e32974d868.png =600x)
...
按下 `Win+R`，粘贴 `cmd /k ping baidu.com -t` 后回车，稍微等待一会，
延迟有上下 10ms 左右的波动都属于正常情况。

**也可以检查游戏对局内 ==正中央下方数字网络延迟== 有没有一直在跳变，若有则很可能说明有人是 Wifi，网络不稳定，不建议进行游戏**
