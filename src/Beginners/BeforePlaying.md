...
2. 点更新服务器列表`（一般选择自己延迟最低的就行，绕远路时综合双方的列表进行选择）`

3. 点中转然后复制 `中转一般选“标准模式”，wifi对局可尝试使用“玄学模式”（确实是玄学）`
...
5. 配置完毕swarm，就可以自己建主，让对方再进入即可

::: warning 
**如果你用带猫头鹰头像的 swarm-old 遇到别人进入后黑屏又退出的情况，可尝试使用 swarm-new**
