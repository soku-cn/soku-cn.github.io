...
* 铜钱: 手上有铜钱时，可在8F内精防（8F内才按下4或1防御，8F前不能拉防），不需要按用卡键，不耗灵，错防也能触发 （原本铜钱效果依然在，照常按用卡键触发）
::: tip 铜钱-精防
- 精防成功后角色有闪光特效，
- 卡槽微量增加，
- 有暗转般的时间停止效果（附加对手在hitstop前停止X帧，相当于自己有利帧多X帧，X与攻击等级有关，3/5/7/10），
- 磨血无效，
...
有缝隙的压制中可多次使用精防
若先前防御不是精防，也在后续防御中使用精防，例如可以普通防御妖梦的DA一段，然后精防妖梦的DA二段
