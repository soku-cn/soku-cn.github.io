...
**默认按 ESC 或“机签的暂停 Pause 键”调出高级菜单，可以看到“快捷键设置”，你可以在那个页面查看和修改各个热键**

**默认是按 HOME 键录制动作，按 INSERT 键播放动作，按 DELETE 键新建一个空白动作并切换过去，按 PAGE UP 键切换下一个动作（也可以在“录制的动作”这一页中上下选择然后按 确认键（体术攻击键？默认是 Z） 来切换到那个动作）**
...
::: info 使用技巧 - 逐帧操作
**把 开关菜单键(默认 ESC) 改为其他按键，或者按“机签的暂停 Pause 键”，就可以在 F11 暂停逐帧的同时，调出练习菜单来设置**
...
**练习模式汉化 2.1.1 版本已修复 “空中受身为Random随机时崩溃” 的 BUG**
...
::: caution
**不要在开启 giuroll 的同时，在 ”观战“ 或“观看 Rep“时打开 F6**

**F6 与 giuroll 之间有内存泄漏 bug，会使游戏崩溃**
