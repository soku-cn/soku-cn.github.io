...
**默认按 ESC 可以打开高级练习模式菜单，可以看到“快捷键设置”，你可以在那个页面查看和修改各个热键**

**默认是按 HOME 键录制动作，按 INSERT 键播放动作，按 DELETE 键新建一个空白动作并切换过去，按 PAGE UP 键切换下一个动作（也可以在“录制的动作”这一页中上下选择然后按Z来切换到那个动作）**
...
![](https://bu.dusays.com/2024/02/02/65bd100e0750a.png =450x)


::: info 使用技巧 - 逐帧操作
**把 开关菜单键(默认 ESC) 改为其他按键，就可以在 F11 暂停逐帧的同时，调出练习菜单来设置**
