import{_ as c,r as l,o as i,c as d,a as s,b as n,d as a,w as t,e as o}from"./app-CRl1Krf4.js";const r={},m=o('<h2 id="old基础功能简介-不带rep转mp4" tabindex="-1"><a class="header-anchor" href="#old基础功能简介-不带rep转mp4"><span>old基础功能简介（不带rep转mp4）</span></a></h2><div class="hint-container info"><p class="hint-container-title">ReplayDnD-old 基础功能简介（不带rep转mp4）</p><ul><li>右键rep文件选择<strong>属性</strong>，<strong>打开方式</strong>设置为 th123.exe 后，双击rep文件即可直接播放rep。这个功能非常实用，不必在游戏内一个一个找rep了</li></ul><ul><li>将包含rep文件的文件夹直接拖到th123.exe上可以连续播放文件夹内的所有rep（按x或者esc来切掉去播下一个，点叉关掉游戏窗口则是完全停止）</li></ul></div><h2 id="新版rep转mp4功能" tabindex="-1"><a class="header-anchor" href="#新版rep转mp4功能"><span>新版Rep转mp4功能</span></a></h2>',3),k={class:"hint-container tip"},u=s("p",{class:"hint-container-title"},"新版 ReplayDnD 的 Rep 转 mp4 视频功能",-1),v={class:"hint-container warning"},b=s("p",{class:"hint-container-title"},"注意",-1),y=s("strong",null,[n("整合包内默认启用 "),s("code",null,"ReplayDnD-old"),n(" 旧版，想要使用新版的功能请手动调整")],-1),h=s("strong",null,"如何开关配置 mod",-1),w=s("li",null,[s("p",null,"使用时可能会偶尔冒出dll被禁用的弹窗，点确认关掉然后忽略即可，无不良影响")],-1),g=s("li",null,[s("p",null,"如果一次性同时运行多个录制，可能会因内存不足或CPU占用过高等引发一系列问题，所以请根据自己的电脑性能资源量力而行")],-1),q=o('<ul><li><p><strong>切换为新版后，先打开一遍游戏</strong>，然后以后右键则的rep文件就会多一个选项 <code>&quot;render to mp4 with soku&quot;</code>，点了就是开始录制了</p></li><li><p><strong>想要同时录制多个rep，请分别在每个rep文件上右键。</strong> <mark>不要多选rep文件一次性右键点录制，会出现问题</mark></p></li></ul><figure><img src="https://bu.dusays.com/2024/06/13/666ac232c75ff.gif" alt="ReplayDnD 快速录制 rep 为 mp4 展示.gif" width="400" tabindex="0" loading="lazy"><figcaption>ReplayDnD 快速录制 rep 为 mp4 展示.gif</figcaption></figure><figure><img src="https://bu.dusays.com/2024/01/21/65acdbe7f0924.webp" alt="游戏标题栏信息，Rendering 58.0s说明已经录了58秒的视频了，@1157.6fps说明当前录制速率为将近20倍速(1200fps)" width="400" tabindex="0" loading="lazy"><figcaption>游戏标题栏信息，Rendering 58.0s说明已经录了58秒的视频了，@1157.6fps说明当前录制速率为将近20倍速(1200fps)</figcaption></figure><div class="hint-container info"><p class="hint-container-title">ReplayDnD的Rep转mp4的特点</p><ol><li><strong>录制速度成倍数</strong>，不需要像录屏软件那样一比一时间录制；（标题栏可以看到，60fps为一倍速，120fps为二倍速，以此类推）</li><li><strong>可多线程录制</strong>，同时录制多个rep为mp4视频，互相之间不干扰，也不被电脑上其他音频干扰；</li><li>录制得到的视频尺寸为 640*480(则的游戏分辨率本来就这么大)，60F帧率，<strong>约5000~10000kbps码率</strong>，可配合改皮肤类mod录制</li><li><strong>注意使用录制功能后，游戏内Config的“FPS显示”会被关掉，导致左下角自己的输入延迟和右下角的帧率不显示，记得自己手动再打开</strong></li><li>根据我自己的使用经验，同时开很多个同时录导致满负荷的话，偶尔会录出来音质较差（如妖梦的B弹幕）的情况，可以考虑重新录制</li><li>我自己电脑目前环境（AMD Ryzen 5500U）录出来的视频的伽马值会偏高（画面异常明亮）。尝试装了最新A卡驱动后，录出来的正常了，但是我整个画面的伽马值反而变成偏高了，懒得深究了。</li></ol></div>',4),_=s("h3",{id:"已知bug",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#已知bug"},[s("span",null,"已知BUG")])],-1),D={class:"hint-container caution"},f=s("p",{class:"hint-container-title"},"新版ReplayDnD的Rep转mp4视频功能的已知BUG",-1),R=s("code",null,"SokuDirectXOptimizations",-1),x=s("code",null,"SokuDirectXOptimizations",-1),P=s("strong",null,"如何开关配置 mod",-1),T=s("li",null,[s("p",null,[n("文件名以及文件路径不能包括百分号"),s("code",null,"%"),n("和英文感叹号"),s("code",null,"!"),n("和`号，否则会发生双击rep文件只打开游戏和不播放rep的情况（ReplayDnD mod没激活就双击rep的话也会这样）")])],-1),L=s("li",null,[s("p",null,"Win7不能用，会报错")],-1),C=s("li",null,[s("p",null,[s("strong",null,"部分 Nvida 系列显卡可能会有以下情况不能使用，原因和解决办法未知")]),s("ul",null,[s("li",null,"右键点 render 后游戏的标题栏无信息或自动关闭，生成0KB~几十KB的无效mp4文件"),s("li",null,"点了后录了一小段然后卡死不动"),s("li",null,"第一次能正常录制，之后就一直出问题了")])],-1),O=s("li",null,[s("p",null,[s("strong",null,"部分 Intel 系列核显可能会有“右键点 render 后如下图所示报错”的情况不能使用，原因和解决办法未知")])],-1),U=s("figure",null,[s("img",{src:"https://bu.dusays.com/2024/06/13/666abd762ca5e.png",alt:"可能是 Intel 系列核显就会这样报错",width:"400",tabindex:"0",loading:"lazy"}),s("figcaption",null,"可能是 Intel 系列核显就会这样报错")],-1),V=s("h2",{id:"命令行脚本流水线无人值守自动录制rep文件为1080p视频上传至b站",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#命令行脚本流水线无人值守自动录制rep文件为1080p视频上传至b站"},[s("span",null,"命令行脚本流水线无人值守自动录制Rep文件为1080P视频上传至B站")])],-1),F={class:"hint-container info"},H=s("p",{class:"hint-container-title"},"需要用到的软件和工具",-1),S={href:"https://www.bandisoft.com/bandizip/",target:"_blank",rel:"noopener noreferrer"},N={href:"https://www.7-zip.org/",target:"_blank",rel:"noopener noreferrer"},B={href:"http://ffmpeg.org/",target:"_blank",rel:"noopener noreferrer"},I={href:"https://github.com/HandBrake/HandBrake",target:"_blank",rel:"noopener noreferrer"},E=s("ul",null,[s("li",null,[n("然而CLI版 "),s("code",null,"--preset-import-file"),n(" 直接读取json预设文件存在 Bug 无法生效，所以我必须得下载GUI版本，再使用 "),s("code",null,"--preset-import-gui"),n(" 选项才能读取其默认的json预设。我平常也用GUI版本所以多下一个无所谓，不想再下载GUI版本的话就得自己手动编写下命令行参数，或者用其他软件替代")])],-1),A={href:"https://github.com/biliup/biliup-rs/",target:"_blank",rel:"noopener noreferrer"},M=s("li",null,[s("p",null,"在线转换10位时间戳的网页小工具，用于设置B站的定时发布（大于4小时，小于15天），网上有很多在线网站可转换")],-1),W={href:"https://www.python.org/",target:"_blank",rel:"noopener noreferrer"},j=s("div",{class:"hint-container note"},[s("p",{class:"hint-container-title"},"待添加的功能"),s("ul",null,[s("li",null,"远程接收Rep文件或压缩包，解压并自动加入流水线队列")])],-1),G={class:"hint-container important"},z=s("p",{class:"hint-container-title"},"bat脚本文件内的各项参数说明（注意配置环境路径，末尾不要带反斜杠）",-1),X=s("li",null,[s("p",null,[s("code",null,'set "Rep_Root=C:\\Users\\1\\Desktop\\【非想天则Rep】\\录Rep工程"')]),s("ul",null,[s("li",null,"自己创建一个工程文件夹，然后设置路径")])],-1),Z=s("li",null,[s("p",null,[s("code",null,'set "TH123path=C:\\Users\\1\\Desktop\\【2024-06-24 完整游戏】\\th123"')]),s("ul",null,[s("li",null,"这是非想天则游戏th123文件夹的路径，确保开启了 ReplayDnD")])],-1),Y=s("p",null,[s("code",null,'set "C:\\Users\\1\\Desktop\\HandBrakeCLI\\HandBrakeCLI.exe"')],-1),Q=s("li",null,"这是 handbrake-CLI 软件的路径",-1),K={href:"https://handbrake.fr/docs/en/1.7.0/cli/cli-options.html",target:"_blank",rel:"noopener noreferrer"},J=s("p",null,[s("code",null,'set "biliup_path=C:\\Users\\1\\Desktop\\biliupR-v0.2.1-x86_64-windows"')],-1),$=s("li",null,"这是 biliup软件的路径",-1),ss=s("li",null,"若没有手动登陆 biliup 软件，运行脚本时检测到 Cookies 文件不存在会让你登陆，登陆成功后再使用脚本",-1),ns=s("li",null,[s("strong",null,"biliup 软件的工作目录必须在自己的文件夹内，这样才能正常读取 Cookies 登录信息，否则上传会失败")],-1),as={href:"https://biliup.github.io/index.html",target:"_blank",rel:"noopener noreferrer"},es=s("li",null,[s("code",null,"--dtime"),n(" 是定时发布，后面接10位时间戳 "),s("code",null,"VideoUploadTime"),n(" ，要求比现在"),s("strong",null,"晚4个小时但不超过15天，非法时间点会导致消耗网络上传完毕后被白白丢弃"),n("；若不加该参数则不定时发布而是即时发布")],-1),os=s("li",null,[s("p",null,[s("mark",null,[s("strong",null,'FFmpeg 路径请到"系统环境变量"里设置！')])])],-1),ps=o('<div class="hint-container tip"><p class="hint-container-title">脚本使用方法说明</p><ol><li>创建工程文件夹用于 <code>Rep_Root</code>，阅读其他参数并设置好参数的路径</li><li>点开rep文件夹，将其中任意一个文件拖拽到此 bat 上即可，会把整个文件夹的rep文件 逐个录制+合并+压制+截图+上传+归档</li><li>一个任务开始了，此时再点开另外一个rep文件夹，继续拖拽文件到此 bat 上，会使其加入等待队列，一旦前面的任务完成即可接着执行</li><li>复制此 bat 创建副本，修改 <code>Workingtxt</code> 避免冲突，即可多条流水线，建议不超过 3 个，否则会很卡</li><li>在录制rep过程中可直接关闭cmd窗口终止脚本，但是则的窗口建议最好不要终止，否则要手动删除未完成的mp4，已经录过的rep不会重新录</li><li>压制过程中终止脚本，需要手动删除未完成的1080P视频</li></ol></div>',1),ts=o(`<details class="hint-container details"><summary>（录制+压制+上传）三段合一的bat脚本示例</summary><div class="language-batch line-numbers-mode" data-ext="batch" data-title="batch"><pre class="language-batch"><code><span class="token comment">rem https://wiki.514.live/mods/AdvancedMods/ReplayDnD.html</span>
...
<span class="token command"><span class="token keyword">endlocal</span></span>
<span class="token command"><span class="token keyword">pause</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="相关链接" tabindex="-1"><a class="header-anchor" href="#相关链接"><span>相关链接</span></a></h2>`,5),ls={class:"hint-container tip"},cs=s("p",{class:"hint-container-title"},"相关链接",-1),is={href:"https://wiki.514.live/mods/AdvancedMods/ReplayDnD.html",target:"_blank",rel:"noopener noreferrer"},ds=s("br",null,null,-1),rs={href:"https://www.bilibili.com/opus/942465276772876307",target:"_blank",rel:"noopener noreferrer"},ms=s("br",null,null,-1),ks={href:"https://sokureplays.delthas.fr/",target:"_blank",rel:"noopener noreferrer"},us=s("br",null,null,-1);function vs(bs,ys){const p=l("RouteLink"),e=l("ExternalLinkIcon");return i(),d("div",null,[m,s("div",k,[u,s("div",v,[b,s("ul",null,[s("li",null,[s("p",null,[y,n(),a(p,{to:"/mods/WhatsMod.html"},{default:t(()=>[h]),_:1})])]),w,g])]),q]),_,s("div",D,[f,s("ul",null,[s("li",null,[s("p",null,[n("录制 mp4 功能不能和 "),R,n(" mod 同时使用，会造成录出来的视频以倍速播放的 bug，请关掉 "),x,n(" mod 再使用录制功能 "),a(p,{to:"/mods/WhatsMod.html"},{default:t(()=>[P]),_:1})])]),T,L,s("li",null,[s("p",null,[n("打了"),a(p,{to:"/FAQ/In-Games/MissingGraphic.html"},{default:t(()=>[n("Intel 核显特效消失（变成一根线）的补丁")]),_:1}),n("后，使用Rep转mp4功能会报错无法使用")])]),C,O]),U]),V,s("div",F,[H,s("ul",null,[s("li",null,[s("p",null,[s("a",S,[n("Bandzip 解压缩软件"),a(e)]),n("有个智能解压并删除的功能，我挺喜欢的。也可以用 "),s("a",N,[n("7z 解压缩软件"),a(e)]),n(" ，随你喜欢")])]),s("li",null,[s("p",null,[s("a",B,[n("FFmpeg 软件(推荐 Shared 版本)"),a(e)]),n("+设置FFmpeg路径环境变量，用于合并录制来的视频得到640x480的长视频，以及截取视频中的一帧当作1920x1080的视频封面")])]),s("li",null,[s("p",null,[s("a",I,[n("Handbrake 视频压制软件，CLI 命令行版和 GUI 可视界面版两个都要下"),a(e)]),n("，用于放大分辨率并压制得到1440x1080视频，支持GPU硬件编码，效率较高。")]),E]),s("li",null,[s("p",null,[s("a",A,[n("biliup-rs 命令行B站视频上传软件"),a(e)]),n("，它既有CLI命令行版，也有GUI可视界面版，也有录播版")])]),M,s("li",null,[s("p",null,[n("（可选项）"),s("a",W,[n("python 环境"),a(e)]),n("发送邮件，用于提醒流水线工作完成")])])]),j]),s("div",G,[z,s("ul",null,[X,Z,s("li",null,[Y,s("ul",null,[Q,s("li",null,[s("a",K,[n("handbrake 命令行参数说明"),a(e)])])])]),s("li",null,[J,s("ul",null,[$,ss,ns,s("li",null,[s("a",as,[n("biliup使用说明+命令行参数说明"),a(e)])]),es])]),os]),ps]),ts,s("div",ls,[cs,s("p",null,[s("a",is,[n("https://wiki.514.live/mods/AdvancedMods/ReplayDnD.html"),a(e)]),ds,s("a",rs,[n("https://www.bilibili.com/opus/942465276772876307"),a(e)]),ms,n(" 使用ReplayDnD Mod流水线自动录制rep并投稿1080P【2024-09-21】")]),s("p",null,[s("a",ks,[n("https://sokureplays.delthas.fr/"),a(e)]),us,n(" 大厅内Bot自动观战记录战绩")])])])}const ws=c(r,[["render",vs],["__file","ReplayDnD.html.vue"]]),gs=JSON.parse('{"path":"/mods/AdvancedMods/ReplayDnD.html","title":"双击rep文件观看，rep转mp4视频功能-ReplayDnD","lang":"zh-CN","frontmatter":{"title":"双击rep文件观看，rep转mp4视频功能-ReplayDnD","icon":"circle-info","order":20,"editLink":false,"author":"三回転Tstar","date":"2024-08-23T00:00:00.000Z","description":"old基础功能简介（不带rep转mp4） ReplayDnD-old 基础功能简介（不带rep转mp4） 右键rep文件选择属性，打开方式设置为 th123.exe 后，双击rep文件即可直接播放rep。这个功能非常实用，不必在游戏内一个一个找rep了 将包含rep文件的文件夹直接拖到th123.exe上可以连续播放文件夹内的所有rep（按x或者esc...","head":[["meta",{"property":"og:url","content":"https://wiki.514.live/mods/AdvancedMods/ReplayDnD.html"}],["meta",{"property":"og:site_name","content":"非想天则指南"}],["meta",{"property":"og:title","content":"双击rep文件观看，rep转mp4视频功能-ReplayDnD"}],["meta",{"property":"og:description","content":"old基础功能简介（不带rep转mp4） ReplayDnD-old 基础功能简介（不带rep转mp4） 右键rep文件选择属性，打开方式设置为 th123.exe 后，双击rep文件即可直接播放rep。这个功能非常实用，不必在游戏内一个一个找rep了 将包含rep文件的文件夹直接拖到th123.exe上可以连续播放文件夹内的所有rep（按x或者esc..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://bu.dusays.com/2024/06/13/666ac232c75ff.gif =400x"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-03-10T08:04:28.000Z"}],["meta",{"property":"article:author","content":"三回転Tstar"}],["meta",{"property":"article:published_time","content":"2024-08-23T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2025-03-10T08:04:28.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"双击rep文件观看，rep转mp4视频功能-ReplayDnD\\",\\"image\\":[\\"https://bu.dusays.com/2024/06/13/666ac232c75ff.gif =400x\\",\\"https://bu.dusays.com/2024/01/21/65acdbe7f0924.webp =400x\\",\\"https://bu.dusays.com/2024/06/13/666abd762ca5e.png =400x\\"],\\"datePublished\\":\\"2024-08-23T00:00:00.000Z\\",\\"dateModified\\":\\"2025-03-10T08:04:28.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"三回転Tstar\\"}]}"]]},"headers":[{"level":2,"title":"old基础功能简介（不带rep转mp4）","slug":"old基础功能简介-不带rep转mp4","link":"#old基础功能简介-不带rep转mp4","children":[]},{"level":2,"title":"新版Rep转mp4功能","slug":"新版rep转mp4功能","link":"#新版rep转mp4功能","children":[{"level":3,"title":"已知BUG","slug":"已知bug","link":"#已知bug","children":[]}]},{"level":2,"title":"命令行脚本流水线无人值守自动录制Rep文件为1080P视频上传至B站","slug":"命令行脚本流水线无人值守自动录制rep文件为1080p视频上传至b站","link":"#命令行脚本流水线无人值守自动录制rep文件为1080p视频上传至b站","children":[]},{"level":2,"title":"相关链接","slug":"相关链接","link":"#相关链接","children":[]}],"git":{"createdTime":1704618486000,"updatedTime":1741593868000,"contributors":[{"name":"Tstar00","email":"1434716883@qq.com","commits":17},{"name":"三回転Tstar","email":"1434716883@qq.com","commits":1}]},"readingTime":{"minutes":15.24,"words":4573},"localizedDate":"2024年8月23日","autoDesc":true,"excerpt":"<h2>old基础功能简介（不带rep转mp4）</h2>\\n<div class=\\"hint-container info\\">\\n<p class=\\"hint-container-title\\">ReplayDnD-old 基础功能简介（不带rep转mp4）</p>\\n<ul>\\n<li>右键rep文件选择<strong>属性</strong>，<strong>打开方式</strong>设置为 th123.exe 后，双击rep文件即可直接播放rep。这个功能非常实用，不必在游戏内一个一个找rep了</li>\\n</ul>\\n<!-- - rep文件可能要和th123.exe在同一个盘符内 -->\\n<ul>\\n<li>将包含rep文件的文件夹直接拖到th123.exe上可以连续播放文件夹内的所有rep（按x或者esc来切掉去播下一个，点叉关掉游戏窗口则是完全停止）</li>\\n</ul>\\n</div>"}');export{ws as comp,gs as data};
