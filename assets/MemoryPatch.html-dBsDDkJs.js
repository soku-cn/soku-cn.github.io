import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as e,f as d}from"./app-3UXz5b7X.js";const l={},s=d(`<div class="hint-container info"><p class="hint-container-title">功能简介</p><p>MemoryPatch 默认开启，里面各个详细部分可自己选择</p><p>打开对应ini文件，会看到各个部分 （<code>th123\\Modules\\MemoryPatch\\MemoryPatch.ini</code>）</p><p><code>Enabled=1</code> 为开启</p><p><code>Enabled=0</code> 为关闭</p></div><details class="hint-container details"><summary>[2-20] 可使用的补丁如下</summary><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[General]
